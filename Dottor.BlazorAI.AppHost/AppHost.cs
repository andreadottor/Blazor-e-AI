...
var aiModel      = builder.AddParameter("ai-openai-model", secret: true, value: builder.Configuration["AI:OpenAI:Model"] ?? string.Empty);
var aiEndpoint   = builder.AddParameter("ai-openai-endpoint", secret: true, value: builder.Configuration["AI:OpenAI:Endpoint"] ?? string.Empty);
var aiApiKey     = builder.AddParameter("ai-openai-api-key", secret: true, value: builder.Configuration["AI:OpenAI:ApiKey"] ?? string.Empty);
var aiImageModel = builder.AddParameter("ai-openai-image-model", secret: true, value: builder.Configuration["AI:OpenAI:ImageModel"] ?? string.Empty);
